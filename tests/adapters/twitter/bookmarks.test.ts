/**
 * Port of opencli's clis/twitter/bookmarks.test.js.
 *
 * Pure-helper coverage: imports the re-exported `__test__` helpers
 * (parseBookmarks / extractBookmarkTweet) straight off the bundled file.
 */
import { describe, expect, it } from 'vitest';
import { __test__ } from '../../../marketplace/twitter/bookmarks.js';

const { parseBookmarks, extractBookmarkTweet } = __test__;

describe('twitter bookmarks parser (marketplace)', () => {
