/**
 * Port of opencli's clis/twitter/list-tweets.test.js.
 *
 * The bundled file re-exports the parser helpers by name (no __test__ wrapper),
 * matching opencli's `import { extractTimelineTweet, parseListTimeline }`.
 */
import { describe, expect, it } from 'vitest';
import { extractTimelineTweet, parseListTimeline } from '../../../marketplace/twitter/list-tweets.js';

import '../../../marketplace/twitter/list-tweets.js';

describe('twitter list-tweets parser (marketplace)', () => {
    ...
    const tweet = extractTimelineTweet(
      {
        ...
        core: {
          user_results: {
            result: { legacy: { screen_name: 'bob', name: 'Bob', description: 'List author bio' } },
          },
        },
      },
      new Set(),
