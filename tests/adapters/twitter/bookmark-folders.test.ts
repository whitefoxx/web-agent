/**
 * Port of opencli's clis/twitter/bookmark-folders.test.js.
 */
import { describe, expect, it, vi } from 'vitest';
import { findAdapter } from '../../../src/runtime/registry.js';
import { __test__ } from '../../../marketplace/twitter/bookmark-folders.js';

import '../../../marketplace/twitter/bookmark-folders.js';

const { parseBookmarkFolders, buildUrl } = __test__;

describe('twitter bookmark-folders parser (marketplace)', () => {
...
describe('twitter bookmark-folders URL builder (marketplace)', () => {
...
describe('twitter bookmark-folders command (marketplace)', () => {
  const command = findAdapter('twitter', 'bookmark-folders');
