/**
 * Port of opencli's clis/twitter/thread.test.js.
 */
import { describe, expect, it } from 'vitest';
import { findAdapter } from '@base/runtime/registry.js';
import { __test__ } from '../../../marketplace/twitter/thread.js';

import '../../../marketplace/twitter/thread.js';

describe('twitter thread parser (marketplace)', () => {
  it('extracts author bio from tweet user entity', () => {
    const command = findAdapter('twitter', 'thread');
