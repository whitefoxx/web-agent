/**
 * Port of opencli's clis/linkedin/salesnav-inbox.test.js.
 */
import { describe, expect, it } from 'vitest';
import { CommandExecutionError } from '@base/runtime/errors.js';
import '../../../marketplace/linkedin/salesnav-inbox.js';
...
const {
  ...
  salesnavThreadUrl,
  threadListUrl,
} = (await import('../../../marketplace/linkedin/salesnav-inbox.js')).__test__ as any;
...
describe('linkedin salesnav-inbox command', () => {
  ...
  it('parses Sales Navigator thread rows with other participant and unread state', () => {
    const rows = parseSalesnavThreads({
      elements: [
        {
          id: '2-thread',
