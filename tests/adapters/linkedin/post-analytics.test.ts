/**
 * Port of opencli's clis/linkedin/post-analytics.test.js.
 */
import { describe, expect, it } from 'vitest';
import { findAdapter } from '@base/runtime/registry.js';
import { EmptyResultError } from '@base/runtime/errors.js';
import '../../../marketplace/linkedin/post-analytics.js';

const { summarize } = (await import('../../../marketplace/linkedin/post-analytics.js'))
  .__test__ as any;

describe('linkedin post-analytics adapter', () => {
  const command = findAdapter('linkedin', 'post-analytics');
